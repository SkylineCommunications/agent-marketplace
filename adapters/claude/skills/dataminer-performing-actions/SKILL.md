...
> **Skill reference notice:** This skill refers to additional skills that are not included in this public distribution: `dataminer-user-defined-api`. If any of them is required for the current task, inform the user and ask whether to continue while ignoring the missing skill or stop.
